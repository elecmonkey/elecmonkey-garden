...
As you can tell from the previous article, [Bun Team: PR #30412 - Rewrite Bun in Rust / #30683 - Remove .zig source files](https://www.elecmonkey.com/blog/bun-rust-rewrite), I do not like the kind of hot takes that spend all day preaching that AI will overthrow our industry, that the accumulated work of software engineering is now useless, or that AI will replace every programmer.
