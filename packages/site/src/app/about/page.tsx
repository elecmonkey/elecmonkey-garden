      ...
      <div className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
        <section className="mb-12">
          <section className="text-lg text-foreground leading-relaxed">
            <p>
              <span className="font-bold">Elecmonkey</span>
              {isEnglish ? ', frontend developer.' : '，前端开发者。'}
            </p>
            <p>
              {isEnglish
          ...
          <p className="text-lg text-foreground leading-relaxed mt-4">
            {isEnglish
              ? 'A modest technical homepage for recording the pitfalls I have climbed through and the paths I have taken.'
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                <span className="truncate">
                  {isEnglish ? "swwind's blog" : 'swwind 的博客'}
                </span>
                {isEnglish ? (
              ...
              >
                <span className="truncate">
                  {isEnglish ? "Saten's Base" : 'Saten同学的小基地'}
                </span>
                {isEnglish ? (
                  <span className="shrink-0 bg-muted px-2 py-0.5 text-xs font-normal text-muted-foreground">
                    Chinese
