...
export function getMetadata(locale: Locale = 'zh'): SiteMetadata {
  ...
  return {
    title: isEnglish
      ? "Elecmonkey's Garden - Sounding the Heart's Voice"
      : 'Elecmonkey的小花园 - 存在 为将心声响彻',
      ...
      <section className="mb-12">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 p-4">
          ...
          <div className="text-center">
            <h1>
              <span className="text-4xl md:text-5xl max-[430px]:text-[2rem] font-bold">
                Elecmonkey
              </span>
              <span className="text-4xl md:text-5xl max-[430px]:text-[2rem] font-light">
                &apos;s Garden
              </span>
            </h1>
            <p
              className="text-xl md:text-2xl text-muted-foreground mt-3 mb-6"
              title="来自COP《光与影的对白》"
            >
              {' '}
              - 存在 为将心声响彻 -{' '}
