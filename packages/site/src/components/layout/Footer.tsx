      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            >
              <span>
                {isEnglish
                  ? 'Articles are licensed under CC BY-NC-SA 4.0'
                  : '文章采用 CC BY-NC-SA 4.0 许可证'}
              </span>
            </a>
          </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    elec<span style={{ display: 'none' }}>null</span>monkey
                  </span>
                  <span style={{ display: 'none' }}>hidden</span>
                  &#x40;
                  <span style={{ display: 'none' }}>please-no-spam</span>
                  <span>
                    hot<span style={{ display: 'none' }}>spam</span>mail.com
                  </span>
                </span>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 text-center border-t border-border">
          <p className="text-sm text-muted-foreground select-none">
            ...
            {!isEnglish && (
              <>
                <span className="mx-2 text-muted-foreground select-none hidden sm:inline">
                  ｜
                </span>
