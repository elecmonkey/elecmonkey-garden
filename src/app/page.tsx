      ...
      <section className="mb-16">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="relative">
            ...
            {/* Santa Hat */}
            <div className="absolute -top-8 right-0 transform rotate-12 text-red-600">
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24">
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  <path fill="currentColor" d="M12.23 3a7.23 7.23 0 0 1 7.21 6.676l.544 7.073A3 3 0 1 1 15 19l-9 .001a3 3 0 0 1-1-5.83v-2.94A7.23 7.23 0 0 1 12.23 3M18 18a1 1 0 1 0 0 2a1 1 0 0 0 0-2m-2.72-3H6a1 1 0 0 0-.117 1.993L6 17h9.764l.135-.141z"/>
                </g>
              </svg>
            </div>
          </div>
