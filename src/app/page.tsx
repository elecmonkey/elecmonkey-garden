        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 p-4">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link 
                href="/blog" 
                className="px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-200 flex items-center gap-2 whitespace-nowrap shadow-sm hover:shadow select-none"
              >
              ...
              <Link 
                href="/about" 
                className="px-4 py-2 text-foreground bg-muted hover:bg-accent transition-all duration-200 flex items-center gap-2 whitespace-nowrap select-none"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
