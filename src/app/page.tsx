          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <Link 
                ...
                className="px-4 py-2.5 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 flex items-center whitespace-nowrap"
                target="_blank"
