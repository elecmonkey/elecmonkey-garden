      ...
      <ReactMarkdown
        ...
        components={{
          ...
          p: ({ children, node }) => {
            ...
            return (
              <p 
                className={`text-lg my-4 ${hasIndentTag ? 'indent-8' : ''}`}
              >
                {displayContent}
              </p>
            );
          ...
          li: ({ children, className, ...props }) => {
            ...
            if (isTaskItem) {
              return (
                <li className="flex items-start mb-1 pl-1 -ml-1 task-list-item text-lg" {...props}>
                  {children}
                </li>
              );
            }
            ...
            // 常规列表项
            return <li className="mb-1 text-lg" {...props}>{children}</li>;
          },
