        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog" className="text-sm transition-colors text-gray-600 hover:text-blue-600 dark:text-blue-100 dark:hover:text-blue-50">
                  所有文章
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-6 text-center border-t border-gray-200 dark:border-blue-900">
          <p className="text-sm text-gray-600 dark:text-blue-100">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="transition-colors hover:text-blue-600 dark:text-blue-100 dark:hover:text-blue-50"
            >
              陕ICP备2023008974号-1
            </a>
          </p>
